...
//O EXEMPLO SEGUINTE SIMULA OS VALORES DE UMA TABELA VERDADE AND, COM BASE NOS DADOS INSERIDOS PELO USUÁRIO
	...
	//O EXEMPLO SEGUINTE SIMULA OS VALORES DE UMA TABELA VERDADE DO CONDICIONAL (SE..ENTÃO), COM BASE NOS DADOS INSERIDOS PELO USUÁRIO
	...
	//O EXEMPLO SEGUINTE SIMULA OS VALORES DE UMA TABELA VERDADE DO BICONDICIONAL (SE E SOMENTE SE) COM BASE NOS DADOS INSERIDOS PELO USUÁRIO
	...
	//O EXEMPLO SEGUINTE SIMULA OS VALORES DE UMA TABELA VERDADE DO OU EXCLUSIVO (OU...OU) COM BASE NOS DADOS INSERIDOS PELO USUÁRIO
	printf("Vamos Fazer o teste da TABELA VERDADE do BICONDICIONAL (se e somente se)\n" );
	printf("Insira um valor para p, sendo as opções 1 ou 0\n");
	scanf("%d",&p);
